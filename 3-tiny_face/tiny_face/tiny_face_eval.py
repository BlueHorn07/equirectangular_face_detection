...
def evaluate(weight_file_path, src_img, filename, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session() as sess:
    ...
    raw_img = cv2.cvtColor(src_img, cv2.COLOR_BGR2RGB)
    ...
    print("time {:.2f} secs for {}".format(time.time() - start, filename))
